...
if (arguments.includes('createReviews')) {
    ...
    var reviewInstance = new reviewsModel({
        authorName: 'awesome',
        img: "https://images.pexels.com/photos/414612/pexels-photo-414612.jpeg?cs=srgb&dl=beautiful-beauty-blue-414612.jpg&fm=jpg",
        date: Date.now(), gameName: 'something', rating: 3.6, reviewDescription: 'yesh li tsav she korim lo yehoshua'
    });
    ...
    reviewInstance = new reviewsModel({
        authorName: "awesome",
        img: "https://d2skuhm0vrry40.cloudfront.net/2017/articles/2017-10-23-15-36/GTA_5_Online_LEAK_Duke_O_Death_DLC_update_coming_soon_605675.jpg/EG11/resize/300x-1/quality/75/format/jpg",
    ...
    reviewInstance = new reviewsModel({
        authorName: "roey",
        img: "https://hb.imgix.net/fb1a527bf84329358b1732e0432e189a047117f2.jpg?auto=compress,format&fit=crop&h=353&w=616&s=de8581ca3e0437aed022c72a1f8e99f6",
        date: "2019-06-30T13:28:37.048Z",
        gameName: "Doom3",
        rating: 1.3,
        reviewDescription: "Killing monsters and such \nmichael and belete look at aviv he is waiting for ya all \n\nsup sup u guys ",
    })
    reviewInstance.save(function (err) { });
    ...
    reviewInstance = new reviewsModel({
        ...
        rating: null,
        reviewDescription: "The Best Game eveerrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrrr",
    })
